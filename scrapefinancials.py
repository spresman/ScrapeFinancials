...
symbols = ['NTEC', 'ONTX', 'CAPR', 'ATNM', 'CSLK', 'CLSK', 'TRVN', 'AVCT', 'NOVN', 'ETON', 'ktov', 'KTOV', 'BCRX', 'SRNE', 'CYDY', 'ALT', 'CYRN', 'CHFS', 'TLSS', 'canf', 'IDRA', 'NAK', 'UAVS', 'BOXL', 'TORC', 'clsk', 'MGEN', 'htbx', 'bcrx', 'AIM', 'aveo', 'Nak']
